...
#if !defined(S32K142W_FEATURES_H)
#define S32K142W_FEATURES_H
#include <stdint.h>
 ...
 *           Irq compatibility
 **********************************************************************/
#define FTFC_IRQn                               FTFM_IRQn
#define FTFC_Fault_IRQn                         FTFM_Fault_IRQn
#define FTFC_EEERAM_ECC_ERR_IRQn                FTFM_EEERAM_ECC_ERR_IRQn
#define FTFC_Mgate_ECC_ERR_IRQn                 FTFM_Mgate_ECC_ERR_IRQn
...
/* --------------------------------------------------------------------
  Temporary code to build cpu example project when there is NO:
...
#define FEATURE_HAS_LPO_PERIPHERAL_CLOCK_SOURCE (1U)
...
PCC_FTFM_INDEX,                     /*!< FTFM clock source               57 */   \
...
PCC_LPSPI2_INDEX,                   /*!< LPSPI2 clock source             71 */   \
PCC_LPTMR0_INDEX,                   /*!< LPTMR0 clock source             72 */   \
PCC_LPUART0_INDEX,                  /*!< LPUART0 clock source            73 */   \
PCC_LPUART1_INDEX,                  /*!< LPUART1 clock source            74 */   \
PCC_LPUART2_INDEX,                  /*!< LPUART2 clock source            75 */   \
PCC_INVALID_INDEX,                  /*!< End of ASYNCH DIV2 clocks       76 */   \
PCC_INVALID_INDEX,                  /*!< End of PCC clocks               77 */   \
}
...
(HAS_INT_CLOCK_FROM_SLOW_CLOCK),                                                                    /*!< FTFM clock source               57 */   \
...
(HAS_PROTOCOL_CLOCK_FROM_ASYNC2 | HAS_INT_CLOCK_FROM_BUS_CLOCK),                                    /*!< LPSPI2 clock source             71 */   \
(HAS_MULTIPLIER | HAS_DIVIDER | HAS_PROTOCOL_CLOCK_FROM_ASYNC2 | HAS_INT_CLOCK_FROM_BUS_CLOCK),     /*!< LPTMR0 clock source             72 */   \
(HAS_PROTOCOL_CLOCK_FROM_ASYNC2 | HAS_INT_CLOCK_FROM_BUS_CLOCK),                                    /*!< LPUART0 clock source            73 */   \
(HAS_PROTOCOL_CLOCK_FROM_ASYNC2 | HAS_INT_CLOCK_FROM_BUS_CLOCK),                                    /*!< LPUART1 clock source            74 */   \
(HAS_PROTOCOL_CLOCK_FROM_ASYNC2 | HAS_INT_CLOCK_FROM_BUS_CLOCK),                                    /*!< LPUART2 clock source            75 */   \
(NO_PERIPHERAL_FEATURE),                                                                            /*!< End of ASYNCH DIV2 clocks       76 */   \
(NO_PERIPHERAL_FEATURE),                                                                            /*!< End of PCC clocks               77 */   \
}
...
{  SCG_SYSTEM_CLOCK_DIV_BY_3, SCG_SYSTEM_CLOCK_DIV_BY_2, SCG_SYSTEM_CLOCK_DIV_BY_4},  /*!< Dividers for SPLL */ \
}
/* @brief template system clock configuration in VLPR mode*/
#define FEATURE_VLPR_SYS_CLK SCG_SYSTEM_CLOCK_DIV_BY_8
...
#define    PCC_FTFM0_CLOCK          FTFM0_CLK
...
/* @brief High speed run mode was not available on this device(register bit PMPROT[AHSRUN]). */
#define FEATURE_SMC_HAS_HIGH_SPEED_RUN_MODE (0U)
...
/**********************************************************************
 *           Interrupts module features
 **********************************************************************/
/* @brief Lowest interrupt request number. */
#define FEATURE_INTERRUPT_IRQ_MIN         (NonMaskableInt_IRQn)
/* @brief Highest interrupt request number. */
#define FEATURE_INTERRUPT_IRQ_MAX         (FTFC_Mgate_ECC_ERR_IRQn)
...
#define FEATURE_MSCM_HAS_INTERRUPT_ROUTER (0u)
/* @brief Has directed CPU interrupt routerregisters (IRCPxxx). */
#define FEATURE_MSCM_HAS_CPU_INTERRUPT_ROUTER (0u)
...
#define FEATURE_PDB_HAS_INTERCHANNEL_BACKTOBACK (1)
...
#define FEATURE_FTM_HARDWARE_TRIGGER_SOURCE     (1U)
/* @brief The FTM has the fixed clock source */
#define FEATURE_FTM_HAS_FIXED_CLOCK_SOURCE      (1U)
...
#define FEATURE_FTM_HAS_SIM_EXT_CLK             (1U)
...
#define FEATURE_CAN_HAS_MBDSR3                  (0)
...
#define FEATURE_CAN_MB_IRQS                 { CAN_ORed_0_15_MB_IRQS, \
                                              ...
                                              CAN_ORed_32_47_MB_IRQS, \
                                              CAN_ORed_48_63_MB_IRQS }
...
#define FEATURE_CAN_HAS_HR_TIMER            (0)
/* @brief Has FlexCAN Enhanced Rx FIFO mode */
#define FEATURE_CAN_HAS_ENHANCED_RX_FIFO    (0)
/* @brief Has FlexCAN expandable memory */
#define FEATURE_CAN_HAS_EXPANDABLE_MEMORY   (0)
/**********************************************************************
...
/* @brief Special region descriptor. */
#define FEATURE_MPU_SPECIAL_REGION            (0U)
...
#define FEATURE_MPU_REGION_0_ACCESS_RIGHT_RESET_VALUE    (0x0061F7DFU)
...
privilege rights for user and supervisor mode accesses (e.g. master0~3 in S32K14xW).
*/
#define FEATURE_MPU_MAX_LOW_MASTER_NUMBER     (3U)
/* @brief Specifies maximum number of masters which have only
read and write permissions (e.g. master4~7 in S32K14xW).
*/
...
/* @brief Specifies number of set access control right bits for
   ...
   supervisor mode accesses (e.g. master0~3 in S32K14xW).
*/
#define FEATURE_MPU_LOW_MASTER_CONTROL_WIDTH  (6U)
/* @brief Specifies number of set access control right bits for
   masters which have only read and write permissions(e.g. master4~7 in S32K14xW).
*/
...
#define FEATURE_CSEC_HAS_FTFM_MODULE					  (1U)
...
/**********************************************************************
 *           MPU_PAL module features
 **********************************************************************/



#endif /* S32K142W_FEATURES_H */
/*******************************************************************************
 * EOF
 ******************************************************************************/
