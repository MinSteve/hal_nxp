...
**                                      RM Rev.12.1.
**     - rev. 1.1 Taru Shree 05-Apr-21  Initial release based on
**                                      RM Rev.13.
**
** ###################################################################
*/
...
/* Check if another memory map has not been also included */
  ...
  #error S32K142W memory map: There is already included another memory map. Only one memory map can be included.
