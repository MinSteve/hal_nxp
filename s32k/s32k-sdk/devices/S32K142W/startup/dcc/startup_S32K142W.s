...
//  @purpose: Wind River Diab Compiler Startup File                                                            
//            S32K142W                                                                     
//  @version: 1.0
//  @date:    2017-1-10
//  @build:   b170110
...
//***************************************************************************
// Version: Wind River Diab Compiler                                  
//***************************************************************************
    //.syntax unified
    //.arch armv7-m
...
__isr_vector:
    ...
    .long   CAN0_ORed_IRQHandler                            # CAN0 ORed [Bus Off OR Transmit Warning OR Receive Warning]
    ...
    .long   CAN0_ORed_32_47_MB_IRQHandler                   # CAN0 ORed Message buffer (32-47)
    .long   CAN0_ORed_48_63_MB_IRQHandler                   # CAN0 ORed Message buffer (48-63)
    .long   CAN1_ORed_IRQHandler                            # CAN1 ORed [Bus Off OR Transmit Warning OR Receive Warning]
    ...
    .long   CAN1_ORed_16_31_MB_IRQHandler                   # CAN1 ORed Message buffer (16-31)
    .long   CAN1_ORed_32_47_MB_IRQHandler                   # CAN1 ORed Message buffer (32-47)
    .long   CAN1_ORed_48_63_MB_IRQHandler                   # CAN1 ORed Message buffer (48-63)
