...
#if !defined(S32K144W_FEATURES_H)
#define S32K144W_FEATURES_H
#include <stdint.h>
...
privilege rights for user and supervisor mode accesses (e.g. master0~3 in S32K144W).
*/
#define FEATURE_MPU_MAX_LOW_MASTER_NUMBER     (3U)
/* @brief Specifies maximum number of masters which have only
read and write permissions (e.g. master4~7 in S32K144W).
*/
...
/* @brief Specifies number of set access control right bits for
   ...
   supervisor mode accesses (e.g. master0~3 in S32K144W).
*/
#define FEATURE_MPU_LOW_MASTER_CONTROL_WIDTH  (6U)
/* @brief Specifies number of set access control right bits for
   masters which have only read and write permissions(e.g. master4~7 in S32K144W).
*/
