...
;
        ...
        EXTERN  __VECTOR_RAM
        EXTERN  __VECTOR_TABLE_COPY_END
        EXTERN  .customSection_init$$Base
        EXTERN  .customSection$$Base
        EXTERN  .customSection_init$$Limit
        EXTERN  .data_init$$Base
        EXTERN  .data$$Base
        EXTERN  .data_init$$Limit
        EXTERN  .textrw_init$$Base
        EXTERN  .textrw$$Base
        EXTERN  .textrw_init$$Limit
        EXTERN  .bss$$Base
        EXTERN  .bss$$Limit
...
__vector_table_0x1c
        ...
        DCD     CAN0_ORed_32_47_MB_IRQHandler                 ;CAN0 OR'ed Message buffer (32-47)
        DCD     CAN0_ORed_48_63_MB_IRQHandler                 ;CAN0 OR'ed Message buffer (48-63)
        ...
        DCD     CAN1_ORed_32_47_MB_IRQHandler                 ;CAN1 OR'ed Message buffer (32-47)
        DCD     CAN1_ORed_48_63_MB_IRQHandler                 ;CAN1 OR'ed Message buffer (48-63)
        ...
        DCD     DefaultISR                                    ;166
        DCD     DefaultISR                                    ;167
        DCD     FTFC_EEERAM_ECC_ERR_IRQnHandler               ;FFTC EEERAM ECC error
        DCD     FTFC_Mgate_ECC_ERR_IRQnHandler                ;FFTC Mgate ECC error
        DCD     DefaultISR                                    ;170
        DCD     DefaultISR                                    ;171
        DCD     DefaultISR                                    ;172
        DCD     DefaultISR                                    ;173
...
;; Init table
        SECTION init_table:CODE
__COPY_TABLE
        DCD 4
        DCD __VECTOR_TABLE
        DCD __VECTOR_RAM
        DCD __VECTOR_TABLE_COPY_END
        DCD .customSection_init$$Base
        DCD .customSection$$Base
        DCD .customSection_init$$Limit
        DCD .data_init$$Base
        DCD .data$$Base
        DCD .data_init$$Limit
        DCD .textrw_init$$Base
        DCD .textrw$$Base
        DCD .textrw_init$$Limit
__COPY_TABLE_End
;; Zero table
        SECTION zero_table:CODE
__ZERO_TABLE
        DCD 1
        DCD .bss$$Base
        DCD .bss$$Limit
...
SysTick_Handler
        ...
        PUBWEAK FTFC_EEERAM_ECC_ERR_IRQnHandler
        PUBWEAK FTFC_Mgate_ECC_ERR_IRQnHandler
        PUBWEAK DefaultISR
        SECTION .text:CODE:REORDER:NOROOT(1)
DMA0_IRQHandler
DMA1_IRQHandler
...
FTFC_EEERAM_ECC_ERR_IRQnHandler
FTFC_Mgate_ECC_ERR_IRQnHandler
DefaultISR
        B DefaultISR
